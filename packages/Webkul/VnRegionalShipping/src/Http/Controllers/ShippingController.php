...
namespace Webkul\VnRegionalShipping\Http\Controllers;
...
class ShippingController extends Controller
{
    ...
    {
        $parts = [
            sprintf("<span class='shipping-breakdown-item base-rate'>Phí cơ bản: %s</span>", core()->formatBasePrice($baseRate))
        ];
