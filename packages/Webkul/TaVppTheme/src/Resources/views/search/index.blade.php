    ...
    <main class="page">
        <div class="container">
            ...
            <div class="catalog-layout">
                {{-- Filters Sidebar --}}
                <aside>
                    <form id="filter-form" action="{{ route('shop.search.index') }}" method="GET">
                        ...
                        @if(request()->except(['query', 'page', 'sort', 'limit']))
                            <div class="mt-4">
                                <a href="{{ route('shop.search.index', ['query' => $query]) }}" class="btn btn-sm btn-outline-danger">{{ trans('ta-vpp-theme::app.categories.filters.clear-all') }}</a>
                            </div>
                        @endif
                    </form>
                </aside>
                    ...
                    <div class="product-grid">
                        ...
                        @empty
                            <div class="empty-products" style="grid-column: 1 / -1; text-align: center; padding: 40px;">
                                ...
                                <p>@lang('shop::app.search.no-results')</p>
                            </div>
                        @endforelse
                    </div>
